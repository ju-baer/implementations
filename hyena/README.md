...
regularization. This notebook keeps just the two essential ingredients —
implicit long convolutions and data-controlled gating — to keep the core
idea legible.
...
Hierarchy: Towards Larger Convolutional Language Models,"* 2023.
