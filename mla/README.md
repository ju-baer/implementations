...
variant introduced in [DeepSeek-V2 (DeepSeek-AI, 2024)](https://arxiv.org/abs/2405.04434) and carried forward
into [DeepSeek-V3](https://arxiv.org/abs/2412.19437v1), designed to shrink the KV cache dramatically without
...
DeepSeek-AI, *"[DeepSeek-V3 Technical Report](https://arxiv.org/abs/2412.19437v1),"* 2024.
