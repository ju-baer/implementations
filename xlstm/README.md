...
depends on the last — which is part of why transformers overtook it once
...
- **mLSTM only, not sLSTM.** The paper's other variant, sLSTM, keeps a
  ...
  family as the rest of this repo — GLA, RetNet, and KDA all live right
...
Hochreiter, *"xLSTM: Extended Long Short-Term Memory,"* 2024.
